        ...
        <div>
            {isUpdatePatternModalOpen && (
                ...
                >
                    ...
                    >
                        <div
                            className="flex justify-center mb-8 shadow-xl bg-gradient-to-b from-sky-400 via-sky-700 to-sky-900 px-6 py-3 rounded-t-3xl">
              ...
              <span className="text-sm  font-semibold mb-1 text-white mr-2">
                Pattern Code
                                ...
                                <input
                                    className="cursor-not-allowed bg-sky-800 text-white px-2 py-1 border border-gray-300 rounded-xl mb-2 shadow-md focus:shadow-xl focus:scale-105 transition-all duration-500 outline-none"
                                    type="text"
                                    name="code"
