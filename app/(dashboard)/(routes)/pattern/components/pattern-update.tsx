          ...
          >
            ...
            <form onSubmit={handleSubmit} className="">
              ...
              <div className="flex justify-between items-center mb-4 shadow-md px-2 ">
                ...
                <input
                  className="cursor-not-allowed bg-sky-900 text-white px-2 py-1 border border-sky-600 rounded-xl mb-2 shadow-md focus:shadow-xl focus:scale-105 transition-all duration-500 outline-none"
                  type="text"
                  name="code"
