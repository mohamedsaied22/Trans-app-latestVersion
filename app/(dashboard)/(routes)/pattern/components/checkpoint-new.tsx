...
const NewCheckpoint = ({checkPoints, onCheckpointCreated}) => {
    ...
    useEffect(() => {
        setNewCheckpoint({...newCheckpoint, order: checkPoints.length + 1})
        ...
        <div>
            {isCheckpointsModalOpen && (
                ...
                >
                    ...
                    >
                        <div
                            className="flex justify-center mb-8 shadow-xl bg-gradient-to-b from-sky-400 via-sky-700 to-sky-900 px-6 py-3 rounded-2xl">
