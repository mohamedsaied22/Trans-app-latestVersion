                    ...
                    >
                        <div className="  flex items-center justify-center mb-4 cursor-pointer ">
                            <div className="w-full  ">
                                <div
                                    className="flex text-lg mb-2 shadow-lg p-2 items-center justify-center rounded-2xl font-semibold">
                        ...
                        <div className="flex justify-start ">
                            ...
                            {truck.truckStatus === 'IN_MAINTENANCE' && <ReturnTruckFromMaintenance returnedTruck={truck}
