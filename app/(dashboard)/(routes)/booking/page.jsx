...
export default function BookingsPage() {
    ...
    const handleCloseBookingAPI = async (bookingNumber) => {
        const result = await PUTAPI(`/api/booking/${bookingNumber}/close`)
        if (result.statusCode === 401) {
            ...
            console.log(result)
            setFilteredBookings(filteredBookings.map(booking => booking.bookingNumber === result.bookingNumber ? result : booking))
                ...
                <div className="overflow-x-auto max-w-screen-lg">
                    <table className="w-full divide-y bg-white shadow-xl rounded-xl ">
                        ...
                        <tr>
                            ...
                            <th className="py-3 px-6 text-center">Pattern</th>
                        ...
                        {currentBookings.map((booking, index) => (
                            ...
                            >
                                ...
                                <td className="text-center">
                                    {booking.pattern ? booking.pattern.name : "..........."}
                                </td>
                                ...
                                <td className="py-2 px-6 text-center">
                                    {booking.bookingStatus !== "CLOSED" && <div className="flex items-center justify-center">
                                        <UpdateBooking
                                            bookings={filteredBookings}
                                            booking={booking}
                    ...
                    /> */}
                                        <CloseBooking
                                            booking={booking}
                                            onBookingClosed={handleCloseBookingAPI}
                                        />
                                    </div>}
                                </td>
                            </tr>
