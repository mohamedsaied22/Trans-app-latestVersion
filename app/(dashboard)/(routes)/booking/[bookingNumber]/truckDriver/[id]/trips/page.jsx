...
const TripsInfo = ({params}) => {
    ...
    useEffect(() => {
        if (truckDriver)
            setTripList(truckDriver.tripList)
    }, [truckDriver]);
                ...
                <Card
                    ...
                    <div className="  flex items-center justify-center mb-4  ">
                        <div className="w-full ">
                            <div
                                className="flex text-lg  mb-2 bg-gray-100 shadow-xl p-2 items-center justify-center rounded-t-2xl font-semibold">
                        ...
                        <div className="w-full">
                            <div className="w-full">
                                ...
                                <div className="flex justify-between mb-2 shadow-md p-2">
                                    ...
                                    <div className="text-right">
                                        {truckDriver.tripList.filter(trip => !trip.isOpened).length || 0}
                                    </div>
                                </div>
