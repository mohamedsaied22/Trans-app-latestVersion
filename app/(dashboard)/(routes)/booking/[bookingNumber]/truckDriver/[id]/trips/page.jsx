...
const TripsInfo = ({ params }) => {
  ...
  return (
    <div>
      ...
      className="px-4 md:px-12 lg:px-32 space-y-4 grid  xl:grid-cols-2 gap-4">
        <Card className=" p-4 border-black/5 flex flex-col mt-4 shadow-md hover:shadow-xl transition rounded-2xl ">
          <div className="  flex items-center justify-center mb-4  ">
            <div className="w-full ">
              <div className="flex text-lg  mb-2 bg-gray-100 shadow-xl p-2 items-center justify-center rounded-2xl font-semibold">
          ...
          <Card
            className="p-4 border-black/5 grid  shadow-md hover:shadow-2xl transition rounded-2xl "
          >
            <div className="flex items-center  justify-center mb-4">
                <div className="w-full ">
                  <div className="flex justify-between mb-2 rounded-2xl shadow-md p-2">
                  ...
                  <div className="flex justify-center mb-2 rounded-2xl shadow-md p-2">
