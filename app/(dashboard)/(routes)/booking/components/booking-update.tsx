    ...
    <div>
      {isUpdateBookingModalOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed cursor-auto z-50 inset-0 flex items-center justify-center bg-gray-700 bg-opacity-70"
        >
          <motion.div
            id="modal"
            ref={modalRef}
          ...
          >
            ...
            <div className="flex justify-between items-center mb-4 shadow-md px-2 ">
              ...
              <input
                className=" cursor-not-allowed bg-sky-800 text-gray-300 border-sky-600 px-2 py-1 border-2 rounded-xl mb-2 shadow-md focus:shadow-xl focus:scale-105 transition-all duration-500 outline-none"
                type="text"
                name="bookingNumber"
      ...
      {booking.status !== "Closed" && ( // Add conditional rendering here
        <button
          className={` px-1 py-1 text-sm bg-sky-700 text-white rounded-lg shadow-lg  ${
            isButtonClicked
              ? "hover:bg-sky-400"
