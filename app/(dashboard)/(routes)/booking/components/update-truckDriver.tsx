...
import {fetcher} from "@/utities/test";
...
const UpdateTruck = ({ truck, onUpdateTruck }) => {
  ...
  useEffect(() => {
    if (updateTruck.contractor) {
      const contractor = getContractor(updateTruck.contractor);
